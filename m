...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 2A36D207AEC
	for <lists+linux-arch@lfdr.de>; Wed, 24 Jun 2020 19:54:38 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2405861AbgFXRxm (ORCPT <rfc822;lists+linux-arch@lfdr.de>);
        Wed, 24 Jun 2020 13:53:42 -0400
Received: from mail.kernel.org ([198.145.29.99]:55780 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S2405519AbgFXRxm (ORCPT <rfc822;linux-arch@vger.kernel.org>);
        Wed, 24 Jun 2020 13:53:42 -0400
Received: from localhost.localdomain (unknown [2.26.170.173])
        (using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
        (No client certificate requested)
        by mail.kernel.org (Postfix) with ESMTPSA id 7CA06207E8;
        Wed, 24 Jun 2020 17:53:37 +0000 (UTC)
...
Subject: [PATCH v5 22/25] arm64: mte: Enable swap of tagged pages
Date:   Wed, 24 Jun 2020 18:52:41 +0100
Message-Id: <20200624175244.25837-23-catalin.marinas@arm.com>
...
Notes:
 ...
 include/asm-generic/pgtable.h    | 1285 ++++++++++++++++++++++++++++++
 mm/shmem.c                       |    2 +-
 8 files changed, 1472 insertions(+), 2 deletions(-)
 create mode 100644 arch/arm64/mm/mteswap.c
 create mode 100644 include/asm-generic/pgtable.h
...
new file mode 100644
index 000000000000..09eb80160920
--- /dev/null
...
index 6cf6a1ed3d1c..66024b1884c1 100644
--- a/mm/shmem.c
+++ b/mm/shmem.c
@@ -1677,7 +1677,7 @@ static int shmem_swapin_page(struct inode *inode, pgoff_t index,
