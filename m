Return-Path: <linux-arch+bounces-14822-lists+linux-arch=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-arch@lfdr.de
Delivered-To: lists+linux-arch@lfdr.de
Received: from dfw.mirrors.kernel.org (dfw.mirrors.kernel.org [142.0.200.124])
	by mail.lfdr.de (Postfix) with ESMTPS id 7547BC61D37
	for <lists+linux-arch@lfdr.de>; Sun, 16 Nov 2025 21:57:29 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by dfw.mirrors.kernel.org (Postfix) with ESMTPS id B30C04EC0E5
	for <lists+linux-arch@lfdr.de>; Sun, 16 Nov 2025 20:55:17 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 7781E310640;
	Sun, 16 Nov 2025 20:51:30 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=linutronix.de header.i=@linutronix.de header.b="C0G5XDG9";
	dkim=permerror (0-bit key) header.d=linutronix.de header.i=@linutronix.de header.b="aeDnOvsb"
X-Original-To: linux-arch@vger.kernel.org
Received: from galois.linutronix.de (Galois.linutronix.de [193.142.43.55])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 3346530F921;
	Sun, 16 Nov 2025 20:51:27 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=193.142.43.55
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1763326290; cv=none; b=CzbruiOTVJ+++9uz2UA3a0fjHYP17WmyNzlR6SaimioyuX4+biaMtYMx/cKuoXXqaS+2RYiZWGin2R1ssDln/OgC3wZLOq7nSbdDytN4D+frXy0IRZfF/kz427aDCkCzKyBhrhkN8m/CKXDODYqCafZrOcAuaYufErjCJOnm8gA=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1763326290; c=relaxed/simple;
	bh=Ze7YxQc8VmGJWvWDX+lpgQCwe22yhXA1Wge59ayVU00=;
	h=Message-ID:From:To:Cc:Subject:References:MIME-Version:
	 Content-Type:Date; b=bunfbHt80RrDYQWEpYgBmsCPTU7xdx3qsdGFzKYW4+Pny5Z0EA769oyjlfUZobmi7KFLdL5pT3qblvVAusJzF7Q1nr6uhHfE5fdMltImRKMVxtRYHMcxwboTAWZDXx0Un4WQOqOgXP0WPuSbuYX8rDBsMQ2UFb34eSVt1ruZ8K8=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linutronix.de; spf=pass smtp.mailfrom=linutronix.de; dkim=pass (2048-bit key) header.d=linutronix.de header.i=@linutronix.de header.b=C0G5XDG9; dkim=permerror (0-bit key) header.d=linutronix.de header.i=@linutronix.de header.b=aeDnOvsb; arc=none smtp.client-ip=193.142.43.55
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linutronix.de
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=linutronix.de
Message-ID: <20251116174751.242060448@linutronix.de>
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=linutronix.de;
	s=2020; t=1763326286;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 references:references; bh=zA5EA8UGBKUMzutSzPqYqfU9J4/SvfjSxdu/ipcDFQA=;
	b=
DKIM-Signature: v=1; a=ed25519-sha256; c=relaxed/relaxed; d=linutronix.de;
	s=2020e; t=1763326286;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 references:references; bh=zA5EA8UGBKUMzutSzPqYqfU9J4/SvfjSxdu/ipcDFQA=;
	b=aeDnOvsbw/L3cifxj4C0+lm/+6Gw6AbUUKIpInon0YRR9hrLBr4BLC+J/5LsyX1lWGUV5Q
	Bp9b18763EttkRCw==
...
Subject: [patch V4 10/12] rseq: Implement rseq_grant_slice_extension()
...
Date: Sun, 16 Nov 2025 21:51:25 +0100 (CET)
...
@@ -665,6 +772,7 @@ static inline void rseq_syscall_exit_to_
