...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 934BD25078A
	for <lists+linux-arch@lfdr.de>; Mon, 24 Aug 2020 20:28:47 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726886AbgHXS2q (ORCPT <rfc822;lists+linux-arch@lfdr.de>);
        Mon, 24 Aug 2020 14:28:46 -0400
Received: from mail.kernel.org ([198.145.29.99]:35282 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726793AbgHXS2n (ORCPT <rfc822;linux-arch@vger.kernel.org>);
        Mon, 24 Aug 2020 14:28:43 -0400
Received: from localhost.localdomain (unknown [95.146.230.145])
        (using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
        (No client certificate requested)
        by mail.kernel.org (Postfix) with ESMTPSA id 254F32075B;
        Mon, 24 Aug 2020 18:28:40 +0000 (UTC)
...
Subject: [PATCH v8 17/28] arm64: mte: Allow user control of the tag check mode via prctl()
Date:   Mon, 24 Aug 2020 19:27:47 +0100
Message-Id: <20200824182758.27267-18-catalin.marinas@arm.com>
...
index 6e77fbdd653a..5d9710e0be9a 100644
--- a/arch/arm64/kernel/process.c
+++ b/arch/arm64/kernel/process.c
@@ -579,6 +579,13 @@ __notrace_funcgraph struct task_struct *__switch_to(struct task_struct *prev,
 	 */
 	dsb(ish);
...
@@ -638,9 +645,15 @@ static unsigned int tagged_addr_disabled;
...
+	if (arg & ~valid_mask)
 	...
 	/*
@@ -650,6 +663,9 @@ long set_tagged_addr_ctrl(unsigned long arg)
...
+
 	...
 	return 0;
@@ -657,13 +673,17 @@ long set_tagged_addr_ctrl(unsigned long arg)
