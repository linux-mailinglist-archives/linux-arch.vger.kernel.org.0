Return-Path: <linux-arch+bounces-14859-lists+linux-arch=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-arch@lfdr.de
Delivered-To: lists+linux-arch@lfdr.de
Received: from dfw.mirrors.kernel.org (dfw.mirrors.kernel.org [142.0.200.124])
	by mail.lfdr.de (Postfix) with ESMTPS id EF160C69142
	for <lists+linux-arch@lfdr.de>; Tue, 18 Nov 2025 12:30:12 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by dfw.mirrors.kernel.org (Postfix) with ESMTPS id E76264F0F71
	for <lists+linux-arch@lfdr.de>; Tue, 18 Nov 2025 11:28:58 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id B60503502B9;
	Tue, 18 Nov 2025 11:28:24 +0000 (UTC)
X-Original-To: linux-arch@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 9432E23EABB;
	Tue, 18 Nov 2025 11:28:24 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1763465304; cv=none; b=RfsUNqtpnljJZ59gOc+FmJx77xG396BNGgDALe3MUd40t3t1FBkhz4vwjUchdGEj1pfeMmgaj6trIKVmf/HfDYShnZINjz5DoTZkeIlWPxWyNhq7Jh7VpR/PbSEzrE1lMQDDwORYLuJ8RBq6b84Hb9rpGoqcRRT5soAV/YPqovw=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1763465304; c=relaxed/simple;
	bh=rGFwKWu1nyTe60pXDkwCsbfROOSuHGAfvTiWT8Q+cfg=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=qHRS6/DTD8eFyGVyvtLlNYi8Rj9DE62PI3nXTbCJ1YFp1zpP7aComgs7Dhdod1tdhuN7hUT0BvsYrD9suHc90rAqtgnovylmbcwcuQRURfpPlYCwilXdngZYPOLl9xQQ0ZyPg0VMuX1swY0+oIAnjwY0rHUBS+6sMuUtW7HYeQ0=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 190CAC2BCB6;
	Tue, 18 Nov 2025 11:28:20 +0000 (UTC)
...
Subject: [PATCH V2 02/14] LoongArch: Add adaptive CSR accessors for 32BIT/64BIT
Date: Tue, 18 Nov 2025 19:27:16 +0800
Message-ID: <20251118112728.571869-3-chenhuacai@loongson.cn>
...
---
 ...
 arch/loongarch/kernel/cpu-probe.c        | 17 +++++++--
...
index 6f943d1391ff..97933e9e2aa3 100644
--- a/arch/loongarch/kernel/cpu-probe.c
+++ b/arch/loongarch/kernel/cpu-probe.c
@@ -314,11 +314,22 @@ static inline void cpu_probe_loongson(struct cpuinfo_loongarch *c, unsigned int
 	if (!cpu_has_iocsr)
 		return;
