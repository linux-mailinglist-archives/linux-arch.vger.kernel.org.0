...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 0799A25078F
	for <lists+linux-arch@lfdr.de>; Mon, 24 Aug 2020 20:28:53 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726939AbgHXS2t (ORCPT <rfc822;lists+linux-arch@lfdr.de>);
        Mon, 24 Aug 2020 14:28:49 -0400
Received: from mail.kernel.org ([198.145.29.99]:35376 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726840AbgHXS2p (ORCPT <rfc822;linux-arch@vger.kernel.org>);
        Mon, 24 Aug 2020 14:28:45 -0400
Received: from localhost.localdomain (unknown [95.146.230.145])
        (using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
        (No client certificate requested)
        by mail.kernel.org (Postfix) with ESMTPSA id 64EAF2074D;
        Mon, 24 Aug 2020 18:28:42 +0000 (UTC)
...
Subject: [PATCH v8 18/28] arm64: mte: Allow user control of the generated random tags via prctl()
Date:   Mon, 24 Aug 2020 19:27:48 +0100
Message-Id: <20200824182758.27267-19-catalin.marinas@arm.com>
...
index 5d9710e0be9a..b8e96b631aa8 100644
--- a/arch/arm64/kernel/process.c
+++ b/arch/arm64/kernel/process.c
@@ -651,7 +651,7 @@ long set_tagged_addr_ctrl(unsigned long arg)
 		return -EINVAL;
